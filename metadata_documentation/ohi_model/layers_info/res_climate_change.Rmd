Multiple data sources were used to calculate the climate change resilience layer including American Council for Energy Efficiency (ACEE), America’s Pledge Report, US Energy Information Administration (EIA), and the Environmental Protection Agency (EPA) (TABLE: data sources all layers). There are 4 data layers used in the climate change resilience layer.

**Presence**

1. The state's scores from the annual [ACEE State Energy Efficiency Scorecard](https://aceee.org/state-policy/scorecard), which scores each state on their energy efficient policies; the target is the maximum possible score of 50^[American Council for an Energy-Efficient Economy 2019, The State Energy Efficiency Scorecard. Washington D.C.: American Council for an Energy-Efficient Economy.]. 

2.  State level climate friendly actions since the United States exit from the Paris Climate Agreement; This information is taken from [America’s Pledge Report](https://www.bbhub.io/dotorg/sites/28/2017/11/AmericasPledgePhaseOneReportWeb.pdf) which lists the number of climate friendly actions in 33 categories. For this layer, we removed the energy efficiency categories as to not double count and states are scored based on actions taken in 30 different categories; the target is at least one action in each of the category^[America’s Pledge, “America’s Pledge Phase 1 Report: States, Cities, and Businesses in the United States Are Stepping Up on Climate Action,” November 2017.].
