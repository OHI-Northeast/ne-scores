...
1. The Surfrider Foundation releases an annual [State of the Beach Reportcard](https://www.surfrider.org/coastal-blog/entry/2017-state-of-the-beach-report) (since 2017) which scores each coastal state on their policies to protect their beaches from coastal erosion, haphazard development, and sea level. A score of 10/10 results in an A+. We rescaled these scores 0-1^[Surfrider Foundation (2017), State of the Beach Report. San Clemente, CA].

2. [NOAA GARFO shapefiles](https://archive.fisheries.noaa.gov/garfo/educational_resources/gis/data/indextab.html) were used to identify areas where fisheries regulations are in place that prohibit trawling and dredging are prohibited year-round; target is 30% protected^[NOAA Greater Atlantic Region Fisheries Office, GIS Datasets. https://archive.fisheries.noaa.gov/garfo/educational_resources/gis/data/indextab.html].
