...
3. We extracted the total number of staff,  patrols, and outreach events OLE partakes from the NOAA OLE Northeast Region Annual report. These are summed up and rescaled 0-1 using the highest historic total as the reference point. This information was given to us in PDF report form for 4 years. This data in raw form, over the entire period of time would be optimal, if this data becomes avaliable.

**Effectiveness/Compliance**

4. The USGS Nonindigenous Aquatic Species database was used to inform this layer. Locally specific occurrence data was used to calculate the total number of occurrences in each region that have become established and eradicated. This layer was calculated by dividing the number of species eradicated by the number of new occurrences in each region each year. This data in raw form, over the entire period of time would be optimal, if this data becomes avaliable.
